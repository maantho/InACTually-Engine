...
#define DMXPRO_SEND_LABEL		        06			// Output Only Send DMX Packet Request
#define DMXPRO_RECEIVE_ON_CHANGE_LABEL  8
#define DMXPRO_RECEIVE_PACKET_LABEL     5
#define DMXPRO_BAUD_RATE		        250000		// virtual COM doesn't control the usb, this is just a dummy value
#define DMXPRO_FRAME_RATE		        20			// dmx send frame rate
...
//////////////////////////////////////////////////////////
// LAST 4 dmx channels seem not to be working, 508-511 !!! || might be fixed!
//////////////////////////////////////////////////////////
...
public:
	...
	static DMXProRef create(const std::string& deviceName, DeviceMode mode = SENDER)
	{
	...
	static void listDevices()
	{
		...
		CI_LOG_I("--- DMX usb pro > List serial devices ---");

		for (std::vector<ci::Serial::Device>::const_iterator deviceIt = devices.begin(); deviceIt != devices.end(); ++
			deviceIt)
			CI_LOG_I(deviceIt->getName());
