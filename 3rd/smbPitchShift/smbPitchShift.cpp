...
/*
	Routine smb_PitchShift(). See top of file for explanation
...
*/
{
	...
	for (i = 0; i < numSampsToProcess; i++){
		...
		if (gRover >= fftFrameSize) {
			...
			/* ***************** ANALYSIS ******************* */
			/* do transform */
			smb_Fft(gFFTworksp, fftFrameSize, -1);
...
/*
    ...
    instances of atan2() with calls to the smb_Atan2() function below.
